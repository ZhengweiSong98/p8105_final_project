...
Analysis of Variance (ANOVA) is a statistical test used to determine if there is a statistically significant difference between categorical groups. In general, we expect there are one or more group might be influential on the dependent variable, while the other group treated as control group. 
...
These assumptions were [checked](mlr_fatality.html), and our model meet these requirement.
