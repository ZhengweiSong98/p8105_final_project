...
* We employed automatic search procedures, criterion based approaches, and the LASSO technique to select a final model with the outcome of death rate (DR) and totally 7 parameters: 

$$\widehat{DR}=-0.572+0.079 \cdot ln(location=inland)+0.002 \cdot vaccinated-0.004 \cdot labor\;rate+0.066 \cdot ln(test)+0.034 \cdot ln(area)+0.073 \cdot ln(unemployment)$$
