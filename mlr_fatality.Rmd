...
$\widehat{Death\;Rate}=-0.572+0.079 \cdot ln(location=inland)+0.002 \cdot vaccinated-0.004 \cdot labor\;rate+0.066 \cdot ln(test)+0.034 \cdot ln(area)+0.073 \cdot ln(unemployment)$
