...
* We employed automatic search procedures, criterion based approaches, and the LASSO technique to select a final model with the outcome of death rate and totally 7 parameters: 
...
where "DR" is death rate (fatality), "vacci" indicates the vaccination situation, and "unemploy' accounts for unemployment rate.
