...
We apply ANOVA test to our linear regression, uses the F-test to determine whether the variables fits the data as well as our model. If that F-statics are sufficiently large, or P-values are significantly small，then we can conclude that your model fits the data better than the intercept-only model. 
