...
All of the data used in this investigation originally came from [California Health and Human Service Open Data Portal](https://data.chhs.ca.gov/organization/california-department-of-public-health). This is a website with numerous databases, directly held by the department of public health, California. 

The two specific datasets that will be used for this investigation later is listed below, extracted from the site by simply downloading them into the R project:
